...
/// 主题：WhatsApp 官方配色 + Apple HIG 式字体层级。
///
...
///
/// 字体层级（大小 × 粗细严格区分，参考 iOS 大标题体系）：
///   largeTitle 34/w700  页面大标题、月度汇总大数字
///   title     22/w600   区块大标题
///   navTitle  17/w600   导航栏标题（卡片主标题同档）
///   body      16/w400   正文
///   subhead   14/w400   列表第二行（常规粗细 + 灰，与主标题对比）
///   footnote  13/w400   辅助说明
///   caption   12/w400   时间戳、单位（再小一档 11）
class AppTheme {
  AppTheme._();
  ...
  static const Color bubbleOut = Color(0xFFDCF8C6); // 浅色气泡绿（自己发出的）

  static const Color ink = Color(0xFF111B21);
  static const Color inkSecondary = Color(0xFF667781);
  static const Color inkTertiary = Color(0xFF8696A0);
  ...
  /// 卡片/列表主标题：17/w600（WhatsApp 联系人名式加粗）。
